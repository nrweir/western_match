...
from nets import multilayer_CSAE, get_standard_callbacks
...
act_reg = 0
optimizer = "Adam"
lrs = np.power(10, np.arange(-6, -1).astype('float32'))
# END MODEL VARIABLES #

# TRAINING VARIABLES #
epochs = 50
cb_path = '/n/denic_lab/Users/nweir/python_packages/western_match/outputs/multi_csae_lr_opt_'
es = False
es_patience = 10
sbo = True
...
histories = []
for lr in lrs:
    current_CSAE = multilayer_CSAE(input_shape=input_shape, conv_depth=conv_depth,
...
output_df.to_pickle('/n/denic_lab/Users/nweir/python_packages/western_match/outputs/multilayer_lr_opt.pkl')
